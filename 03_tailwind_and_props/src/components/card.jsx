...
export default function Card({title="bydefault"}) {
  // props is an object that contains all the properties passed to the component
  // For example, if you pass <Card title="Hello" />, then props will be { title: "Hello" }

  // You can access the properties like this: props.title
console.log(title);
